...
const CONFIG = {
  ...
  // 游戏设置
  TYPEWRITER_SPEED: 40,       // 打字机速度(ms)
  DICE_ANIM_DURATION: 1200,   // 骰子动画时长(ms)
  AUTO_SAVE_INTERVAL: 60000,  // 自动存档间隔(ms)
  MAX_HISTORY_TOKENS: 4000,   // AI上下文最大token数
...
const CHARACTERS = {
  baili: {
    ...
    // 心理骰子 (心理特质 1-20，影响AI决策)
    psychology: {
      courage: 16,     // 勇气
      rationality: 18, // 理智 - 极为冷静
      loyalty: 17,     // 忠义
      ambition: 12,    // 野心 - 较低
      suspicion: 14,   // 猜疑
      obsession: 13    // 执念
  ...
  husilin: {
    ...
    psychology: {
      courage: 18,      // 勇气极高 - 天不怕地不怕
      rationality: 11,  // 理智最低 - 容易暴怒
      loyalty: 16,
      ambition: 13,
      suspicion: 15,
      obsession: 14
...
const PSYCH_NAMES = {
  courage: '勇气', rationality: '理智', loyalty: '忠义',
  ambition: '野心', suspicion: '猜疑', obsession: '执念'
};
